package com.kltn.minioservice.service.impl;


import com.tlum.minioservice.config.MinioClientConfiguration;
import com.tlum.minioservice.service.MinioService;
import io.minio.*;
...
public class MinioServiceImpl implements MinioService {
    ...
    public String getRootFolder(String channel) {
        ...
        return channel + "/" + calendar.get(Calendar.YEAR) + "/" + (calendar.get(Calendar.MONTH) + 1) + "/" + calendar.get(Calendar.DAY_OF_MONTH);
    }
